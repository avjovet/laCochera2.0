...
function obtenerProductos(page, itemsPerPage) {
    fetch(`productosTotal.php?page=${page}&itemsPerPage=${itemsPerPage}`)
        .then(response => response.json())
        .then(data => {
            ...
            <td class="centritoloco">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="#" class="editarproducto" data-id="${producto.idProducto}">Editar</a>
                        <a href="#" class="eliminar-producto" data-id="${producto.idProducto}">Eliminar</a>
                        <a href="#" class="ocultar-producto" data-id="${producto.idProducto}">${accionOcultar}</a>
                    </div>
                </div>
            </td>
        </tr>
