                    ...
                    <div class="main-content">
                        ...
                        <div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="thfiltro" id="Nombrefiltro" data-order="asc" data-field="nombre"><span class="header-text">Estado</span> <i id="nombrefilter" class="fas fa-sort"></i></th>
                                        <th class="thfiltro" id="Preciofiltro" data-order="asc" data-field="precio"><span class="header-text">Fecha</span> <i id="preciofilter" class="fas fa-sort"></i></th>
                                        <th class="thfiltro" id="Categoriafiltro" data-order="asc" data-field="categoria"><span class="header-text">FechaAprobacion</span> <i id="categoriafilter" class="fas fa-sort" ></i></th>
                                        <th class="thfiltro" id="Categoriafiltro" data-order="asc" data-field="Mesa"><span class="header-text">Mesa</span> <i id="categoriafilter" class="fas fa-sort" ></i></th>
                                        <th class="thfiltro" id="Categoriafiltro" data-order="asc" data-field="Tipo"><span class="header-text">Tipo</span> <i id="categoriafilter" class="fas fa-sort" ></i></th>
                                        <th class="thfiltro" id="Categoriafiltro" data-order="asc" data-field="Mediopago"><span class="header-text">Medio pago</span> <i id="categoriafilter" class="fas fa-sort" ></i></th>
                                    </tr>
                                </thead>
