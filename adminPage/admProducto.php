                ...
                <main>
                    <div class="main-content">
                        ...
                        <div class="formulario_producto" id="formularioProducto">
                            <!-- Aquí va el formulario de entrada de datos -->
                            ...
                            <div>
                                <form class="row gy-2 gx-3 align-items-center" id="formProducto">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <input type="text" class="form-control" id="autoSizingInputprecio" placeholder="Precio">
                                    </div>
                                    <div class="col-auto">
                                        <label class="visually-hidden" for="autoSizingInput">img</label>
                                        <input type="text" class="form-control" id="autoSizingInputimg" placeholder="Imagen dir">
                                    </div>
                                    <div class="col-auto">
                                        <label class="visually-hidden" for="autoSizingSelect">Preference</label>
                                        <select class="form-select" id="autoSizingSelectcat">Categoria
                                        <option selected disabled hidden>Categoria</option>
                                        <option value="1">Sanguche</option>
                                        <option value="2">Salchipapa</option>
                                        <option value="3">Choripapa</option>
                                        <option value="4">Parrilla</option>
                                        <option value="5">Refresco</option>
                                        <option value="6">Infusion</option>
                                        <option value="7">Bebida</option>
                                        <option value="8">Agregado</option>
                                        </select>
                                    </div>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="thfiltro" id="Preciofiltro" data-order="asc" data-field="precio"><span class="header-text">Precio</span> <i id="preciofilter" class="fas fa-sort"></i></th>
                        ...
                        <div class="modal-content">
                            ...
                            <div>
                                <form class="row gy-2 gx-3 align-items-center" id="formEditarProducto">
                                    ...
                                    <div class="col-auto">
                                        <label class="visually-hidden" for="autoSizingInput">price</label>
                                        <input type="text" class="form-control" id="autoSizingInputprecioEditar" placeholder="Precio">
                                    </div>
                                    <div class="col-auto">
                                        <label class="visually-hidden" for="autoSizingInput">img</label>
                                        <input type="text" class="form-control" id="autoSizingInputimgEditar" placeholder="Imagen dir">
                                    </div>
                                    <div class="col-auto">
                                        <label class="visually-hidden" for="autoSizingSelect">Preference</label>
