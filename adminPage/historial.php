                    ...
                    <div class="main-content">
                            ...
                            <div>
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="thfiltro" id="Nombrefiltro" data-order="asc" data-field="nombre"><span class="header-text">Fecha de modificacion</span> </th>
                                            <th class="thfiltro" id="Preciofiltro" data-order="asc" data-field="precio"><span class="header-text">Cambio</span> </th>
